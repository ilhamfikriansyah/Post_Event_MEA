...
tes3 = pd.crosstab(index=[val_c['comment'], val_c['type_validation']],
        columns='Total',
...
fig_bar_c_true = px.bar(tesx, x="comment", y="Total", text_auto='.2s', 
                    labels={
                        "type_object": "Type Object",
                    },
                    title="Top Comment")
...
fig_bar_c_false = px.bar(tesx, x="comment", y="Total", text_auto='.2s', 
                    labels={
                        "comment": "Comment",
                    },
                    title="Top Comment")
...
tes4 = pd.crosstab(index=[val_s['user_id'], val_s['type_validation']],
        columns='Total',
...
fig_bar_s_true = px.bar(tes4, x="Total", y='user_id', text_auto='.2s', 
                    labels={
                        "user_id": "User",
                    },
                    title="Top User")
...
fig_bar_s_false = px.bar(tes4, x="Total", y='user_id', text_auto='.2s', 
                    labels={
                        "user_id": "User",
                    },
                    title="Top User")
